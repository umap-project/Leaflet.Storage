...
urlpatterns = patterns('',
    ...
    url(r'^marker/json/(?P<category_id>[\d]+)/$', views.MarkerGeoJSONListView.as_view(), name='marker_geojson_list'),
    url(r'^marker/add/$', views.MarkerCreate.as_view(), name='marker_add'),
